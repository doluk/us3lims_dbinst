...
function display_record($link)
{
  ...
  $extrasPAM =
    $enable_PAM
    ? "<tr><th colspan='2' style='background:var(--us-banner-bg);color:var(--us-banner-text);font-weight:bold;font-size:0.82em;letter-spacing:0.06em;text-transform:uppercase;padding:6px 10px;'>Authentication</th></tr>"
...
echo<<<HTML
  ...
  <table cellspacing='0' cellpadding='10' class='style1'>
    ...
    <tbody>
      <tr><th colspan='2' style='background:var(--us-banner-bg);color:var(--us-banner-text);font-weight:bold;font-size:0.82em;letter-spacing:0.06em;text-transform:uppercase;padding:6px 10px;'>Profile Information</th></tr>
      <tr><th>First Name:</th>
          <td>$fname</td></tr>
      <tr><th>Last Name:</th>
          <td>$lname</td></tr>
      ...
      <tr><th>Email:</th>
          <td>$email</td></tr>
      <tr><th colspan='2' style='background:var(--us-banner-bg);color:var(--us-banner-text);font-weight:bold;font-size:0.82em;letter-spacing:0.06em;text-transform:uppercase;padding:6px 10px;'>Account Access</th></tr>
      <tr><th>Registration:</th>
          <td>$activated</td></tr>
      <tr><th>Account status:</th>
          <td>$account_enabled_disp</td></tr>
      <tr><th colspan='2' style='background:var(--us-banner-bg);color:var(--us-banner-text);font-weight:bold;font-size:0.82em;letter-spacing:0.06em;text-transform:uppercase;padding:6px 10px;'>Authorization</th></tr>
      <tr><th>User Level:</th>
          <td>$userlevel</td></tr>
      ...
      $extrasGMP
      $extrasPAM
      <tr><th colspan='2' style='background:var(--us-banner-bg);color:var(--us-banner-text);font-weight:bold;font-size:0.82em;letter-spacing:0.06em;text-transform:uppercase;padding:6px 10px;'>System Access</th></tr>
