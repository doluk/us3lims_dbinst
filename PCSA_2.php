 ...
 * PCSA_2.php
 *
 * Final database update and submission for the PCSA analysis
 *
 */
    ...
    foreach ( $filenames as $filename )
    {
      ...
      if ( ! empty( $retval ) )
      {
        ...
        foreach ( $retval as $rmsg )
        {
          ...
          {
            $output_msg .= "<br /><span class='message' style='color:var(--us-attention);font-weight:bold;'>" .
...
$page_title = 'PCSA Analysis Submitted';
include 'header.php';
